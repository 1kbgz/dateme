...
lint-py:  ## run python linter with ruff
	python -m ruff check dateme
	python -m ruff format --check dateme
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix dateme
	python -m ruff format dateme
...
test-py:  ## run python tests
	python -m pytest -v dateme/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v dateme/tests --cov=dateme --cov-report term-missing --cov-report xml
